...
namespace ImGui
{
    ...
    bool BeginCombo2(const char* label, const char* preview_value, ImGuiComboFlags flags, int items);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImFont* font, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL);

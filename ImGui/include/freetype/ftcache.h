...
FT_BEGIN_HEADER
   ...
   *   to limit the number of concurrently menu_open @FT_Face and @FT_Size
   ...
   *   @FT_Size objects.
   *
   *   The manager intentionally limits the total number of menu_open @FT_Face
   ...
   *
   *   max_faces ::
   *     Maximum number of menu_open @FT_Face objects managed by this cache
   *     instance.  Use~0 for defaults.
   *
   *   max_sizes ::
   *     Maximum number of menu_open @FT_Size objects managed by this cache
   *     instance.  Use~0 for defaults.
   *
   *   max_bytes ::

...
void slowwalk::create_move(CUserCmd* m_pcmd, float custom_speed)
{
	...
	else
	{
		...
		{
			m_pcmd->m_forwardmove = forwardmove / move_length_backup * 25.0f;
			move_length = sidemove / move_length_backup * 25.0f;
			m_pcmd->m_sidemove = sidemove / move_length_backup * 25.0f;
		}
	}
}